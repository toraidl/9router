...
export const APIKEY_PROVIDERS = {
  ...
  "volcengine-ark-agent": { id: "volcengine-ark-agent", alias: "ark-agent", name: "Volcengine Ark Agent", icon: "cloud", color: "#1677FF", textIcon: "ARK+", website: "https://ark.cn-beijing.volces.com", notice: { text: "Volcengine Ark Agent Plan - compatible with Anthropic/OpenAI protocols", apiKeyUrl: "https://console.volcengine.com/ark/region:ark+cn-beijing/apiKey" }, serviceKinds: ["llm", "image"] },
  ...
  sensenova: { id: "sensenova", alias: "sn", name: "SenseNova", icon: "brush", color: "#FF6B35", textIcon: "SN", website: "https://platform.sensenova.cn", notice: { apiKeyUrl: "https://platform.sensenova.cn/apikey", text: "SenseNova API compatible with OpenAI format. T2I endpoint: POST /v1/images/generations. Base: https://token.sensenova.cn/v1" }, serviceKinds: ["image"] },
