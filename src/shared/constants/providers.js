...
export const APIKEY_PROVIDERS = {
  ...
  "volcengine-ark-agent": { id: "volcengine-ark-agent", alias: "ark-agent", name: "Volcengine Ark Agent", icon: "cloud", color: "#1677FF", textIcon: "ARK+", website: "https://ark.cn-beijing.volces.com", notice: { text: "Volcengine Ark Agent Plan - compatible with Anthropic/OpenAI protocols", apiKeyUrl: "https://console.volcengine.com/ark/region:ark+cn-beijing/apiKey" } },
